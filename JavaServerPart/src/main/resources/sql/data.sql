...
VALUES
    ...
    (5, 'Обновление ПО', 'Обновление операционных систем и программного обеспечения', false, ARRAY[9, 0], ARRAY[4, 5], 6000),
    ...
    (8, 'Обслуживание IT инфраструктуры', 'Техническая поддержка и обслуживание оборудования', false, ARRAY[4, 5], ARRAY[9, 0], 11000),
