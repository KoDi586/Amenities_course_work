...
const Warehouse2 = () => {
    ...
    useEffect(
        () => {
            axios.get("http://"+ ip +":8089/api/material/all-by-warehouse?warehouse_id=2").then(response => {
                setWarehouse2(response.data.children)
            }).catch(error => {
                console.log(error);
            });
        }, []
        ...
        <>
            ...
            <Container style={{marginTop: '80px'}}>
                    <Card style={{padding:'25px'}}>
                        <h1 style={{textAlign: 'center'}}>Склад №2</h1>
